...
df=prepare_data(df,kind=k).drop('Price/room',axis=1)
print('Shapes:',df.shape)
print(df.head())
...
fil_loc=filter_per_loc(df,'Barcelona').sort_values('Price/SqM')
#fil_loc[fil_loc['Price/SqM']>=0.3].sort_values('Price/SqM')
